...
<div class="container-fluid mt-4" style="overflow-x: auto;">
    ...
    <div class="card shadow rounded-4" style="min-width: 1255px; width: max-content;">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover align-middle table-bordered" style="min-width: 1150px; width: max-content;">
