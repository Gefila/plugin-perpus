    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="<?= $plugin_url; ?>/rill.jpg" alt="" style="width: 65px; height: 65px; border-radius: 50%;">
            </a>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="admin.php?page=perpus_utama&panggil=kunjungan.php">Entry Kunjungan</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="admin.php?page=perpus_utama&panggil=lapkun.php">Cetak Laporan Kunjungan</a></li>
