...
<div class="container my-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-danger"><i class="fas fa-money-bill-wave"></i> Data Denda Perpustakaan</h2>
        <a href="admin.php?page=perpus_utama&panggil=tambah_denda.php" class="btn btn-danger">
            ...
            <tbody>
                ...
                <tr class="table-light">
                    ...
                    <td class="text-center">
                        <a href="admin.php?page=perpus_utama&panggil=tambah_denda.php&edit=<?= $denda_d1['id_denda'] ?>" class="btn btn-sm btn-primary">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="admin.php?page=perpus_utama&panggil=tambah_denda.php&edit=<?= $row['id_denda'] ?>" class="btn btn-sm btn-primary">
                            <i class="fas fa-edit"></i> Edit
                        </a>
